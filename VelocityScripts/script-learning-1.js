...
#set ($plannedEmployeeNum = $actualPlannedNum.get(0).plan_num * 0.35 )
...
<p>Planned Actual Number of Employees: $plannedEmployeeNum.intValue() of $lead.NumberOfEmployees</p>