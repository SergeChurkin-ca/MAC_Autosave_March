...
FormsPlus.tagWrappers = function tagWrappers() {
    ...
    MktoForms2.whenRendered(function(form) {
        ...
        // temp solution here to hide elements
        let buttonsArray = Array.from(document.querySelectorAll('.mktoButtonRow'))
        buttonsArray.map(x => buttonsArray.indexOf(x) == 0 ? x.style.display = "inline-block" : x.style.display = "none")
    });
