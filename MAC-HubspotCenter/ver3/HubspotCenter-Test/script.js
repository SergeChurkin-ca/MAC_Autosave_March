...
if (window.innerWidth < 1065 && window.innerWidth > 850) {
    innerContainerInitHeight = document.querySelectorAll('.inner-container')[0].clientHeight + threeBoxesHeight - 200;
} else if (window.innerWidth < 850 && window.innerWidth > 550) {
    innerContainerInitHeight = document.querySelectorAll('.inner-container')[0].clientHeight + document.querySelectorAll('.inner-container')[0].clientHeight - 955;

} else if (window.innerWidth < 550) {
    innerContainerInitHeight = document.querySelectorAll('.inner-container')[0].clientHeight + document.querySelectorAll('.inner-container')[0].clientHeight - 1100;
} else {
